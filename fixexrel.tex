...
\section{Introduction and main results}
  \saySS{I changed this paragraph to 1) mention exchange relations; 2) not mention almost positive roots (I fear it may generate confusion on why the exponent of our coefficients is a root); 3) mention Cartan matrices.}
  ...
  In~\cite{FZ03}, Fomin and Zelevinsky showed that cluster algebras of \emph{finite type}, i.e. those containing only a finite number of cluster variables, are classified by finite type \emph{Cartan matrices}.
...
\label{proof}
  ...
  \begin{lemma}
    The support of the difference of any two positive roots in the root system of $\A$ has at most two connected components.
  \end{lemma}
  ...
  \begin{corollary}
    ...
    \saySS{Here I think we really need to say $s_i$ and not just the index $i$}
  \end{corollary}
  \begin{proof}

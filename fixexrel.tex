...
\section{Introduction}
  ...
  \saySS{Change this is Nathan decides not to participate.}
  ...
  The claim in the previous statement lays in the word ``explicitly''. 
...
\section{Proof of \cref{thm:main}}
  ...
  \begin{proof}
    ...
    \saySS{Pavel you said that this is written already somewhere, do you have a reference to add here?}
  ...
  We are finally ready to conclude the proof of \cref{thm:main}.
  ...
  \begin{remark}
    ...
    The analisys required to establish it, though, could be much more complicated than the finite case one because the corank of $B_c$ can be as big as $4$ and the argument of \cref{rk:induction} does not apply.
  \end{remark}

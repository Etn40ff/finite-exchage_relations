...
\section{Proof of \cref{thm:main}}
  ...
  Recall basic notions from \cite{FST,FT}

  \begin{lemma}
    The only cases in which \cref{eq:system} is satisfied by two positive roots involve the exchange of a radius with a chord
  \end{lemma}
  \begin{figure}
    ...
    \end{center}
    \caption{Ambiguous quadrilateral for $D_n$.}
  \end{figure}
